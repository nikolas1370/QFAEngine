...
QFAVKImagePipeline::QFAVKImagePipeline(VkRenderPass rPas, const std::string vertexShaderPath, const std::string fragmentShaderPath)
{
...
QFAVKImagePipeline::~QFAVKImagePipeline()
{
...
std::vector<char> QFAVKImagePipeline::readFile(const std::string& filename)
{
...
VkShaderModule QFAVKImagePipeline::createShaderModule(const std::vector<char>& code)
{
...
void QFAVKImagePipeline::createDescriptorSetLayout()
{
...
VkVertexInputBindingDescription QFAVKImagePipeline::getBindingDescription()
{
...
std::array<VkVertexInputAttributeDescription, 1> QFAVKImagePipeline::getAttributeDescriptions()
{
...
void QFAVKImagePipeline::createDescriptorPool()
{
...
void QFAVKImagePipeline::createDescriptorSets()
{
...
void QFAVKImagePipeline::updataDescriptorSets()
{
    VkDescriptorBufferInfo bufferInfo{};
    bufferInfo.buffer = QFAImage::uniformBufferProj;
    bufferInfo.offset = 0;
    ...
    descriptorWrites[1].pImageInfo = &QFAImage::imageInfo;
